...
> 2026-09-02 срез выведен из активного плана в `BL-004` решением D-038. Спецификация ниже сохраняется как историческая проработка и не является очередью реализации.
