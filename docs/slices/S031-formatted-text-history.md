...
Последующее расширение: [S034](S034-rich-image-paste-stack.md) по D-044 снимает text-only ограничение Stack в новой поставке. Scope и историческое evidence S031 не переписываются.
