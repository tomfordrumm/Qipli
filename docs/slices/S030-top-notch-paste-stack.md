...
Последующее изменение: [S033](S033-compact-notch-paste-stack.md) по D-043 заменяет требование постоянно раскрытого Stack и прежнее исключение compact/hover. S033 принят пользователем 2026-09-15. Остальной контракт и историческое evidence S030 сохраняются.
