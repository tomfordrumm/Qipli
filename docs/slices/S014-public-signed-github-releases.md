...
- PR `#14`, main CI run `33316695418` и protected tag run `33316831828` на commit `8322d34fb30436f128d43c2f709da3d205d87386` прошли 189 tests, universal release gate, app/DMG notarization, credential cleanup, immutable publication и appcast deployment.
- Публичный [`v1.0.5`](https://github.com/tomfordrumm/Qipli/releases/tag/v1.0.5) независимо скачан без release credentials. Versioned ZIP SHA-256 `bf092b29b984d8f89dc8ccb58cc758a82524676f04f83d70ee13e79341220727`, DMG SHA-256 `cae87ef357d20684662513a19288e6d5411d33faa084257c822a3af766044c19`; stable `Qipli.dmg` совпадает byte-for-byte. App `1.0.5 (6)` и DMG прошли Developer ID Team `3N2R5K4J63`, stapler, Gatekeeper, nested signature и `x86_64 arm64` runtime-linking checks.
- PR `#22` и protected tag run `33879324087` на commit `5f440e84ccb6360be9c33b24f3a811790112df8b` опубликовали [`v1.0.8`](https://github.com/tomfordrumm/Qipli/releases/tag/v1.0.8). Независимое unauthenticated скачивание подтвердило ZIP SHA-256 `fd8623669e334e0b117bebad56403dd98cbb556877e73263d6d51939e55940e3`, DMG SHA-256 `0eb6f94392158edd28cdae386c906e2b1ce84a040e4d003cc661eb628f89a4b9`, identical stable `Qipli.dmg`, version `1.0.8 (9)`, Developer ID Team `3N2R5K4J63`, stapler, Gatekeeper, nested Sparkle signatures, `x86_64 arm64` runtime linking и production appcast на immutable ZIP.
