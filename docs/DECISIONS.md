...
- Статус: `proposed`
- Дата: 2026-08-06
- Источник: агент на основании требований и Apple API
...
- Последствия: системные адаптеры нужно отделить от тестируемой state machine; S001 обязан подтвердить разрешения и поведение.
...
- Последствия: status menu обязан давать доступ к основным командам, разрешению и Quit. Решение можно пересмотреть до завершения S001.
