...
## Milestone M3 — Визуальный polish и публичный MVP
...
Результат: визуально цельные адаптивные панели и подписанный notarized артефакт для macOS 14+, проверенный на чистой системе, с понятным описанием разрешений и локальных данных.

## Граф зависимостей

```text
S001 -> S002 -> S003 -> S008
S002 -> S004 -> S005 -> S006 -> S007 -> S008
S001 + S003 + S007 -> S009
```

Граф ацикличен. S009 может выполняться независимо от заблокированного S008. Изменения общих pasteboard/input или panel focus/lifecycle contracts должны сначала согласовываться в `TECHNICAL.md`.
...
| NFR-005–NFR-006 | S003, S004, S006, S007, S009 |
| NFR-007 | S008 |
| NFR-008 | S001–S007, S009 |
| NFR-009 | S009 |
