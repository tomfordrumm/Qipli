...
| BR-035–BR-036 | S034 |
| NFR-034 | S034 |
| FR-049–FR-050 | S035, предложение D-046 |
| BR-037 | S035, предложение D-046 |
| NFR-035 | S035, предложение D-046 |
| FR-051–FR-052 | S036 |
| BR-038 | S036 |
| NFR-036 | S036 |
...
## Milestone M15 — Вырезание файлов с индикацией в чёлке

35. [S035 — Вырезание файлов в Finder](slices/S035-finder-cut-move.md). Предложение D-046; зависимости S033 и S025. S034 не требуется. До основной реализации подтвердить scope и выполнить Finder platform probe. Очерёдность относительно S034 пользователем не назначена.

## Milestone M16 — Последние записи History в меню

36. [S036 — Пять последних записей History в меню](slices/S036-recent-history-menu.md). D-047; зависимости S023/S024/S025/S031 используют существующую typed History реализацию. Оставшийся signed-update gate S031 сохраняется на этапе delivery. S035 не требуется; номер среза не задаёт очерёдность реализации.
